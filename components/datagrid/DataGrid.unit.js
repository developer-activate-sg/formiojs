...
describe('DataGrid Component', function () {
  ...
  it('Should build a data grid component with formio-component-datagrid class property', function () {
    return _harness.default.testCreate(_DataGrid.default, _fixtures.comp6).then(function (component) {
      var element = component.element.querySelector('.formio-component');
      setTimeout(function () {
