...
describe('SaveDraft functionality for Nested Form', function () {
  ...
  before(function (done) {
    ...
    _formioForm.Formio.makeRequest = function (formio, type, url, method, data) {
      ...
      if (type === 'submission' && method === 'get' && _lodash["default"].endsWith(url, '660e75e4e8c776f1225142aa')) {
  ...
  it('Should save draft for Nested Form AND for the Parent Form', function (done) {
    ...
    _formioForm.Formio.createForm(formElement, 'http://localhost:3000/idwqwhclwioyqbw/testdraftparent', {
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          _powerAssert["default"].equal(saveDraftCalls, 2);
  ...
  it('Should restore draft for nested Form', function (done) {
    ...
    _formioForm.Formio.createForm(formElement, 'http://localhost:3000/idwqwhclwioyqbw/testdraftparent', {
      ...
      setTimeout(function () {
        _powerAssert["default"].equal(restoreDraftCalls, 2);
        ...
        _powerAssert["default"].deepEqual(_lodash["default"].get(form.submission.data, 'form.data'), restoredDraftNestedData);
        done();
      }, 200);
    })["catch"](function (err) {
      return done(err);
